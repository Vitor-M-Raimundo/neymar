...
if (isset($_POST['nome'], $_POST['sobrenome'], $_POST['data_nascimento'], $_POST['cpf'], $_POST['telefone'], $_POST['email'], $_POST['senha'])) {
    ...
    // Insere o aluno no banco de dados com hash da senha
    $stmt = $conn->prepare("INSERT INTO aluno (nome, sobrenome, data_nasc, cpf, telefone, email, senha, verificado, token_verificado, foto) VALUES (?, ?, ?, ?, ?, ?, ?, 0, ?, ?)");
